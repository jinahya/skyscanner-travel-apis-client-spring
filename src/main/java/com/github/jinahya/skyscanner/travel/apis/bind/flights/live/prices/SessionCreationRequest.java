...
@SuperBuilder
@Slf4j
public class SessionCreationRequest extends AbstractRequest {
    ...
    public WebClient.RequestHeadersSpec<?> body(final WebClient.RequestBodySpec bodySpec) {
        ...
        return bodySpec.body(fromFormData(formData()));
    }

    public MultiValueMap<String, String> formData(final MultiValueMap<String, String> formData) {
    ...
    public MultiValueMap<String, String> formData() {
        return formData(new LinkedMultiValueMap<>());
    }
